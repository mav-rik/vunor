...
<template>
  ...
  >
    <PaginationList v-slot="{ items }" class="flex items-center gap-1">
      <PaginationFirst v-if="!showEdges && showArrows" class="btn btn-square c8-flat disabled-soft">
        <VuIcon name="i--chevron-left-2" class="btn-icon btn-icon-left" />
      </PaginationFirst>
      <PaginationPrev v-if="showArrows" class="btn btn-square c8-flat disabled-soft mr-4">
      ...
      <PaginationNext v-if="showArrows" class="btn btn-square c8-flat disabled-soft ml-4">
        <VuIcon name="i--chevron-right" class="btn-icon btn-icon-left" />
      </PaginationNext>
      <PaginationLast v-if="!showEdges && showArrows" class="btn btn-square c8-flat disabled-soft">
