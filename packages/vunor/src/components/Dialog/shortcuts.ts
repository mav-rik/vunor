...
export const dialogShortcuts = defineShortcuts({
  ...
  'dialog-card': {
    '': 'fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] focus:outline-none z-[100] shadow-popup overflow-hidden flex flex-col animate-dialog-in',
    'data-[closing]': 'animate-dialog-out opacity-0',
  },
